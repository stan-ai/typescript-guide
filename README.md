...
-   src (All `.ts` files)
    ...
    -   [typescript-express](https://github.com/premraval-pr/typescript-express): This is just a sample Todo REST API created in TypeScript with Express, its another repo on my profile and can be accessed using the link on the point heading or by clicking [here](https://github.com/premraval-pr/typescript-react). Feel free to clone or contribute your changes if you are practicing.
